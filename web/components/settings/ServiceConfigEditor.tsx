                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    ...
                    {service === "llm" && (
                      <>
                        ...
                        {/* Provider-advertised effort options take precedence
                            for regular profiles. Managed Codex profiles use
                            the levels advertised by the bound account. */}
                        {(isCodexOAuth || !effortChoices) &&
