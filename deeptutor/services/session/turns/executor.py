...
class TurnExecutor:
    ...
    async def _run_turn(self, execution: _TurnExecution) -> None:
        ...
        from deeptutor.multi_user.activity import record_turn_finished, record_turn_started

        await asyncio.to_thread(record_turn_started, turn_id, session_id, capability_name)
        attachments = []
        attachment_records = []
