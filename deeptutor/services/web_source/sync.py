...
async def sync_source(
    ...
    *,
    ...
    """
    # Query-only deployments must reject before creating ``raw/`` or making
    # any network request. The API guard is intentionally duplicated here so
    # CLI and direct service callers cannot bypass the server policy.
